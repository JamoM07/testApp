...
def get_unit_numbers_and_repl_costs(fleet_name, uploaded_fleet_list):
    ...
    if uploaded_fleet_list is not None:
            ...
            result_final = df_result.tolist() # extract unit numbers
    ...
    # connected to postgres database
        ...
        result_final = [row[0] for row in result] # extract unit numbers
...
def main(df_cost, df_master_counter, unit_numbers, uploaded_linked_strategy, df_component_counter):
    df_cost_filtered_PM02, fleet_strategy_data = filter_cost_data_pm02(df_cost, unit_numbers, uploaded_linked_strategy)
    ...
    df_cost_supplemented = df_cost#use_estimated_cost(df_cost)
